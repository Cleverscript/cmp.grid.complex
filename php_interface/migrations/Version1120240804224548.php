...
class Version1120240804224548 extends Version
{
    protected $author = "admin";

    protected $description = "Создание инфоблока с компаниями";
    ...
    public function up()
    {
        ...
        $helper->UserOptions()->saveElementForm($iblockId, array (
          ...
          array (
            ...
            'PROPERTY_PHONE' => 'Номер телефона',
            'PROPERTY_FIO_REPRESENTATIVE' => 'ФИО представителя',
